...
#  🚀 4. Implement a program that checks if a given string is a palindrome.
...
#  🚀 7. Write a program to check if a given string is a pangram (contains all letters of the alphabet).
