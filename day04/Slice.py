...
# index from 0 to 2. The last one is not included, and index 0 can be omitted
print(pizza[:2])
...
# index from 0 onwards, and index from 3 onwards
print(quoteA[:])
print(quoteA[3:])
# So you failed.
# you failed.
...
# index from 0 to 26. The last one is not included, and index 0 can be omitted
print(quoteB[:26])
...
# index from 0 to 16, the last one is not included
print(quoteC[0:16]) 
# Make them wonder
